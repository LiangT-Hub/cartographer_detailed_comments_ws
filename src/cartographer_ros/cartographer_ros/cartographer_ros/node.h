...
class Node {
 ...
 private:
  ...
  struct TrajectorySensorSamplers {
    ...
    ::cartographer::common::FixedRatioSampler odometry_sampler;         //odom数据采样器
    ::cartographer::common::FixedRatioSampler fixed_frame_pose_sampler; //GPS数据采样器
    ::cartographer::common::FixedRatioSampler imu_sampler;      //IMU数据采样器
    ::cartographer::common::FixedRatioSampler landmark_sampler; //landmark数据采样器
  };
